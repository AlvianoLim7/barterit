...
class _OrderScreenState extends State<OrderScreen> {
                          ...
                          child: Column(
                            children: [
                              CachedNetworkImage(
                                ...
                                fit: BoxFit.cover,
                                imageUrl:
                                    "${MyConfig().SERVER}/barterit/assets/items/front/${order.buyerItemId}.png",
                          ...
                          child: Column(
                            children: [
                              CachedNetworkImage(
                                ...
                                fit: BoxFit.cover,
                                imageUrl:
                                    "${MyConfig().SERVER}/barterit/assets/items/front/${order.sellerItemId}.png",
                                placeholder: (context, url) =>
                                    const LinearProgressIndicator(),
                                errorWidget: (context, url, error) =>
                                    const Icon(Icons.error),
  ...
  void loadOrder() {
    http.post(Uri.parse("${MyConfig().SERVER}/barterit/php/load_order.php"),
