              ...
              child: SizedBox(
                ...
                child: PageView(
                  children: [
                    ...
                    buildImageCard(
                      imageUrl:
                          "${MyConfig().SERVER}/barterit/assets/items/right/${widget.selecteditems.itemsId}.png",
                    ),
                    buildImageCard(
                      imageUrl:
                          "${MyConfig().SERVER}/barterit/assets/items/left/${widget.selecteditems.itemsId}.png",
                    ),
                  ],
                ),
              ),
